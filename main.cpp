/**
 * @author smarlowe
 * Simple minesweeper game with 3 levels of difficulty.
 */
...
void make_move(int *x,int *y)
{
    while(true)
    {
        ...
        scanf("%d %d", x, y);
        // Checking if larger than board size.
        if ((*x < N) && (*y < N))
        {
            return;
        }
...
// counts and returns the amount of surrounding bombs
...
//void showmines (char realboard[][max_side])
//{
